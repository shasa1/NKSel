...
public class BasePageObject {
	...
	public void waitForAnElementTovisible(final By theElement,int timeoutInSeconds) {
		try {
	...
	public void waitForAnElementToClickable(final By theElement,int timeoutInSeconds) {
		try {
			WebElement element = uiDriver.findElement(theElement);
			WebDriverWait wait = new WebDriverWait(uiDriver, timeoutInSeconds);
	...
	public void javaScriptClick(By theElement) {
		waitForAnElementToClickable(theElement, 10);
		WebElement element = uiDriver.findElement(theElement);
