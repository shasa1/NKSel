...
public class HomePage extends BasePageObject
{
	...
	By getbestmactchedjobsPara= By.xpath("//div[@class='center_large_title']//*[contains(.,'Get best matched')]");
	...
	public HomePage getHeaderLinksName() throws Exception
	{
		...
		try 
		{
			...
			headermanual.add("");
			headermanual.add("Notifications");
	...
	{
		Log.info("Verification of Text of I agree Terms and condition");
		try 
		{
	...
	public ResumeNaukriPage clickOnNaukriCareerNavigatorimageLink() throws Exception
	{
		...
		try 
		{
			...
			for (String ChildResumeQuality : uiDriver.getWindowHandles()) 
			{
				...
				System.out.println("The Title for Actual_Result: "+ Actual_Result);
			}
