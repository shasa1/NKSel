...
public class SearchResultPage extends BasePageObject{	
	...
	By registerNowForm = By.xpath("//input[(@class='orangeBtn') and contains(@value,'Register wi')]");
	...
	By disclaimer = By.xpath("//div[@class='wrap' and contains(.,'All rights reserved @ 2016 Info Edge (India) Ltd.')]");
